...
export default function Pillars() {
  return (
    <div className="w-full h-screen bg-gradient-to-t from-[#060c11] via-indigo-950 to-[#060c11] flex items-center justify-center text-white">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 w-full">
        <div className=" flex flex-col">
          <h1 className="text-3xl sm:text-4xl leading-snug text-start">
